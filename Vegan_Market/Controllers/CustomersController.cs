...
namespace Vegan_Market.Controllers
{
    public class CustomersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "customer_id,customer_name,customer_surname,customer_phone,customer_email,customer_password")] Customer customer)
        {
            if (ModelState.IsValid)
            {
